...
/*
 * MainActivity.java
 * Display the side drawer, and fragments relevant to drawer selection is presented in the view.
 * When app is started, main activity will first check if the user can be automatically logged in.
 */
